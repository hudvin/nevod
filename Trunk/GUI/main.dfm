object FMain: TFMain
    ...
    object cxTab_AFSettings: TcxTabSheet
      ...
      object cxSenderDescription: TcxMemo
        ...
        Lines.Strings = (
            ...
            #1044#1072#1085#1085#1099#1081' '#1092#1080#1083#1100#1090#1088' '#1089#1088#1072#1073#1072#1090#1099#1074#1072#1077#1090','#1077#1089#1083#1080' '#1072#1076#1088#1077#1089' '#1086#1090#1087#1088#1072#1074#1080#1090#1077#1083#1103' '#1085#1072#1093#1086#1076#1080#1090#1089#1103' '#1074' '#1073#1077#1083 +
            #1086#1084' '#1089#1087#1080#1089#1082#1077)
        Properties.HideSelection = False
        Properties.ReadOnly = True
        Style.BorderStyle = ebsNone
        Style.Color = clInfoBk
    ...
    object cxTab_DFSettings: TcxTabSheet
      ...
      object cxBlackWordDescription: TcxMemo
        ...
        Lines.Strings = (
            ...
            #1044#1072#1085#1085#1099#1081' '#1092#1080#1083#1100#1090#1088' '#1089#1088#1072#1073#1072#1090#1099#1074#1072#1077#1090' '#1087#1088#1080' '#1086#1073#1085#1072#1088#1091#1078#1077#1085#1080#1080' '#1074' '#1089#1086#1086#1073#1097#1077#1085#1080#1080' ('#1074' '#1090#1077#1084#1077', '#1074 +
            ' '#1090#1077#1082#1089#1090#1077','#1083#1080#1073#1086' '#1080' '#1090#1072#1084', '#1080' '#1090#1072#1084') '#1086#1087#1088#1077#1076#1077#1083#1077#1085#1085#1086#1075#1086' '
      ...
      object cxBlackSenderDescription: TcxMemo
        ...
        Lines.Strings = (
            ...
            #1044#1072#1085#1085#1099#1081' '#1092#1080#1083#1100#1090#1088' '#1089#1088#1072#1073#1072#1090#1099#1074#1072#1077#1090', '#1077#1089#1083#1080' '#1072#1076#1088#1077#1089' '#1086#1090#1087#1088#1072#1074#1080#1090#1077#1083#1103' '#1085#1072#1093#1086#1076#1080#1090#1089#1103' '#1074' '#1095#1077 +
            #1088#1085#1086#1084' '#1089#1087#1080#1089#1082#1077)
        Properties.HideSelection = False
        Properties.ReadOnly = True
        Style.BorderStyle = ebsNone
        Style.Color = clInfoBk
      ...
      object cxSpinSpamWords: TcxSpinEdit
        Left = 296
        Top = 288
        Properties.MaxValue = 42.000000000000000000
        Properties.MinValue = 1.000000000000000000
      ...
      object cxMaxSpamWords: TcxMemo
        ...
        Lines.Strings = (
            ...
            #1044#1072#1085#1085#1099#1081' '#1092#1080#1083#1100#1090#1088' '#1089#1088#1072#1073#1072#1090#1099#1074#1072#1077#1090','#1077#1089#1083#1080' '#1074' '#1089#1086#1086#1073#1097#1077#1085#1080#1080' '#1082#1086#1083#1080#1095#1077#1089#1090#1074#1086' '#1089#1087#1072#1084'-'#1089#1083#1086#1074' ' +
            #1087#1088#1077#1074#1099#1096#1072#1077#1090' '#1084#1072#1082#1089#1080#1084#1072#1083#1100#1085#1086#1077' '#1079#1085#1072#1095#1077#1085#1080#1077)
        Properties.HideSelection = False
        Properties.ReadOnly = True
        Style.BorderStyle = ebsNone
        Style.Color = clInfoBk
      ...
      object cxMaxSizeDescription: TcxMemo
        ...
        Lines.Strings = (
            ...
            #1044#1072#1085#1085#1099#1081' '#1092#1080#1083#1100#1090#1088' '#1089#1088#1072#1073#1072#1090#1099#1074#1072#1077#1090','#1077#1089#1083#1080' '#1088#1072#1079#1084#1077#1088' '#1089#1086#1086#1073#1097#1077#1085#1080#1103' '#1087#1088#1077#1074#1099#1096#1072#1077#1090' '#1084#1072#1082#1089#1080#1084 +
            #1072#1083#1100#1085#1086#1077' '#1079#1085#1072#1095#1077#1085#1080#1077)
        Properties.HideSelection = False
        Properties.ReadOnly = True
        Style.BorderStyle = ebsNone
        Style.Color = clInfoBk
  ...
  object AList: TActionList
    ...
    object alCheckForUpdates: TAction
      Caption = #1055#1088#1086#1074#1077#1088#1080#1090#1100' '#1086#1073#1085#1086#1074#1083#1077#1085#1080#1103
      OnExecute = alCheckForUpdatesExecute
    end
    object alGotoNevilon: TAction
      Caption = 'Nevilon Software'
      OnExecute = alGotoNevilonExecute
    end
    object alBuyNow: TAction
      Caption = #1050#1091#1087#1080#1090#1100
      OnExecute = alBuyNowExecute
    end
    object alRunAtStartUp: TAction
      Caption = #1047#1072#1087#1091#1089#1082#1072#1090#1100' '#1087#1088#1080' '#1079#1072#1075#1088#1091#1079#1082#1077
      Checked = True
      OnExecute = alRunAtStartUpExecute
    end
    object alEnableClbSpy: TAction
      Caption = #1057#1083#1077#1076#1080#1090#1100' '#1079#1072' '#1073#1091#1092#1077#1088#1086#1084' '#1086#1073#1084#1077#1085#1072
      Checked = True
      OnExecute = alEnableClbSpyExecute
    end
    object alShowEditorForm: TAction
      Caption = #1055#1086#1082#1072#1079#1099#1074#1072#1090#1100' '#1092#1086#1088#1084#1091' '#1087#1088#1080' '#1076#1086#1073#1072#1074#1083#1077#1085#1080#1080
      Checked = True
      OnExecute = alShowEditorFormExecute
    end
    object alShowMainWindow: TAction
      Caption = #1054#1090#1082#1088#1099#1090#1100
      OnExecute = alShowMainWindowExecute
    end
  ...
  object dxBar: TdxBarManager
    ...
    object msCheckForUpdates: TdxBarButton
      Action = alCheckForUpdates
      Category = 0
    end
    object msBuyNow: TdxBarButton
      Action = alBuyNow
      Category = 0
    end
    object msGotoNevilon: TdxBarButton
      Action = alGotoNevilon
      Category = 0
      Hint = 'Nevilon Software'
    end
    object ptAbout: TdxBarButton
      Action = alShowAbout
      Category = 0
    end
    object pGotoNevilon: TdxBarButton
      Action = alGotoNevilon
      Category = 0
    end
    object msRunAtStartUp: TdxBarButton
      Action = alRunAtStartUp
      Category = 0
      ButtonStyle = bsChecked
    end
    object pRunAtStartUp: TdxBarButton
      Action = alRunAtStartUp
      Category = 0
      ButtonStyle = bsChecked
    end
    ...
    object msEnableClbSpy: TdxBarButton
      Action = alEnableClbSpy
      Category = 0
      ButtonStyle = bsChecked
    end
    object pEnableClbSpy: TdxBarButton
      Action = alEnableClbSpy
      Category = 0
      ButtonStyle = bsChecked
    end
    object msShowSpyEditor: TdxBarButton
      Action = alShowEditorForm
      Category = 0
      ButtonStyle = bsChecked
    end
    object pShowSpyEditor: TdxBarButton
      Action = alShowEditorForm
      Category = 0
      ButtonStyle = bsChecked
    end
    object pShowMain: TdxBarButton
      Action = alShowMainWindow
      Category = 0
    end
