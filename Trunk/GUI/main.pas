...
{
при реализации переноса расширени€, адреса, слова
 ¬—≈√ƒј будут различными, так как выполн€етс€ проверка при добавлении в таблицы
...

{
    ...
    замечани€  к структуре
перенести массивы определений (формы дл€ работы со словами)
