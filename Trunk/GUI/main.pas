...
begin
 ...
 SignList.Add(slAnywhere,' в теле и в теме сообщени€ ');
 SignList.Add(slSubject,' в теме сообщени€ ');
 SignList.Add(slBody,' в теле сообщени€ ');
 ...
 with SNConverter do
   begin
    ...
    Add(6,ftWhiteSender,'ƒобавить адрес/домен в белый список',cxTab_Filters,Headers); //адрес в белый список
    Add(10,ftBlackSender,'ƒобавить адрес/домен в черный список',cxTab_Filters,Headers); //адрес в черный список

    Headers.FValue:='File Extension';
    Add(7,ftWhiteAttach,'ƒобавить расширений приложенного файла в белый список',cxTab_Filters,Headers); // расширение в белый список
    Add(11,ftBlackAttach,'ƒобавить расширений приложенного файла в черный список',cxTab_Filters,Headers);// расширение в черный список

    Headers.Params:='Location';
    Headers.FValue:='Word';
    Add(4,ftWhiteWord,'ƒобавить слово в белый список',cxTab_Filters,Headers); // слово в белый список
    Add(9,ftBlackWord,'ƒобавить слово в черный список',cxTab_Filters,Headers); // слово в черный список

    Headers.FValue:='Nevod Stamp';
    Add(5,ftStamp,'ƒобавить штамп',cxTab_Filters,Headers); // штамп
...
begin
 ...
 case AStatus of    //
   ...
   asClient:Text:='загружаетс€ почта ' ;
